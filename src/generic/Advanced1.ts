...
class AgentCollaborationFramework {
  ...
  registerAgent(name: string, agent: BaseAIAgent) {
...
async function main() {
  ...
  console.log(`learningModule:${JSON.stringify(learningModule, null, 2)}`);
  // Agent Collaboration Framework
  const collaborationFramework = new AgentCollaborationFramework();
  console.log(
    `collaborationFramework:${JSON.stringify(collaborationFramework, null, 2)}`
  );
